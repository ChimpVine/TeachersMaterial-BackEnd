...
def update_google_sheet(full_name, email, country, profession, organization, tools_categories, description, sheet_id):
    try:
        # Authenticate and open the Google Sheet
        gc = gspread.service_account(filename="../credentials.json")  # Your service account JSON file
        ...
        values = [full_name, email, country, profession, organization, tools_categories, description]
