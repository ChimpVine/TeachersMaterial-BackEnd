...
def generate_match_term_def(subject, grade, number_of_questions, topic, pdf_text):
    llm = ChatOpenAI(
        model="gpt-4o",
    ...
    prompt_file_path = os.path.join('prompt_template', 'worksheet', 'match_term_def.txt')
    ...
    # Randomize the 'B' options
    random.shuffle(data['worksheet']['options']['B'])
