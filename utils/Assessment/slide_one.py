...
def first_slide(grade, topic, learning_objectives, number_of_slides):
    llm = ChatOpenAI(
        model="gpt-4o-mini",
    ...
    def generate_slide_1(grade,topic, learning_objectives, number_of_slides):
        prompt = prompt_template.replace("{grade}", grade).replace("{topic}", topic).replace("{learning_objectives}", learning_objectives).replace("{number_of_slides}", number_of_slides)
        try:
    ...
    output = generate_slide_1(grade,topic, learning_objectives, number_of_slides)
