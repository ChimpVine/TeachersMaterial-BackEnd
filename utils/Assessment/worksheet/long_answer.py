...
def generate_long_answer(subject, grade, number_of_questions, topic, pdf_text):
    llm = ChatOpenAI(
        model="gpt-4o-mini",
    ...
    prompt_file_path = os.path.join('prompt_template','Assessment', 'worksheet', 'long_answer.txt')
