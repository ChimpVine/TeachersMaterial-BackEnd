...
def generate_tf_simple(subject, grade, number_of_questions, topic, pdf_text):
    llm = ChatOpenAI(
        model="gpt-4o-mini",
    ...
    prompt_file_path = os.path.join('prompt_template','Assessment', 'worksheet', 'tf_simple.txt')
