...
def generate_fib_single(subject, grade, number_of_questions, topic, pdf_text):
    llm = ChatOpenAI(
        model="gpt-4o-mini",
    ...
    prompt_file_path = os.path.join('prompt_template','Assessment', 'worksheet', 'single_fill.txt')
